...
api_id = '3905249'
api_hash = '5cf0f11baffe9ccc929a95893f4b1403'
tg_user_id = ''
tg_bot_token = ''
output_msg = True # 是否打印消息
channel_white_list = [1001427039780,-1001212172599] # 过滤频道消息
cookies = [
        "pt_key=AAJgTFeIADA3Ot76yo8LmFxyi8HVwkb2ZAfCGy-Vrmw-cK69yKj4aQJC4OPNZ3lXGCS9GIu6sx4;pt_pin=tianlangxing866;"
...
@client.on(events.NewMessage(chats=[1001427039780,-1001212172599]))
